...
{
    public class AgentPraying : MonoBehaviour
    {
        Animator animator;
        ...
        void Start()
        {
            ...
            animator.Play("praying_animation", 0, 0f); // Play the praying animation immediately on start
        }
        ...
        void OnTriggerExit(Collider other)
        {
            if (other.CompareTag("Player") && isLookingAtPlayer)
            {
                ...
                // Transition to the "praying_animation" immediately
                animator.Play("praying_animation", 0, 0f);
